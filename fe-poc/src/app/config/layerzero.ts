...
export const MOFT_TOKEN_DECIMALS_SOLANA = 9; // Decimals of your MOFT token on Solana
...
export const getLayerZeroScanLink = (txHash: string, isTestnet: boolean): string => {
    const baseUrl = isTestnet ? 'https://testnet.layerzeroscan.com/tx/' : 'https://layerzeroscan.com/tx/';
